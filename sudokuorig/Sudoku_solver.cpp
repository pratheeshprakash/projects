...
int main()
{
	...
	//Mat sudoku;
	//pyrDown(imread("sudoku.jpg", 0), sudoku);
...
STOP_TIMING(sudTimer);
	...
	bool b = dr->train(" C:/Users/Pratheesh/Desktop/sudoku_solver/train-images.idx3-ubyte", "C:/Users/Pratheesh/Desktop/sudoku_solver/train-labels.idx1-ubyte");
	printf("Trained: %d\n", b);
