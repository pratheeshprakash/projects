...
int main(int argc, char** argv)
{
	...
	int p=3,temp0=1,temp1=1,temp2=1,temp3=0;
	int quit=0;
	char text[200];
	char sendbuffer[] = "<m";
	...
	sprintf(sendbuffer, "<%d",p);	// convert variables to text 
	...
	*/
	...
	//put text on screen
	sprintf(text, "p=%d",p);	// convert variables to text so that they can be displayed on screen
	putText(frame, text, Point(550,20),FONT_HERSHEY_COMPLEX_SMALL, 0.8, cvScalar(0, 0,0), 1, CV_AA);	// display text on screen
